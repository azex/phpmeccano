...
8) Новый модуль ядра *\_\_loader\_\_.php*, загружаемый вместе с файлом конфигураций *conf.php*, содержит:
...
* функция **dbLink** для упрощённого полученич ссылки на базу данных.
...
* модуль ядра **__loader__.php** загружается с самим файлом конфигураций.
